...
char szTemp[32];
  ...
  { 
    ...
    oledWriteString(&oled, 0,4,1,(char *)"  Low-Cost", FONT_8x8, 0, 1);
    oledWriteString(&oled, 0,8,2,(char *)" Telematics", FONT_8x8, 0, 1);
    oledWriteString(&oled, 0,8,3,(char *)"  device", FONT_8x8, 0, 1);
    oledWriteString(&oled, 0,4,4,(char *)" developed at", FONT_8x8, 0, 1);
    oledWriteString(&oled, 0,24,5,(char *)"IIT Bombay", FONT_8x8, 0, 1);
    //oledWriteString(&oled, 0,24,6,(char *)"****************", FONT_8x8, 0, 1);
    //ledWriteString(&oled, 0,0,7,(char *)"**************** ", FONT_8x8, 0, 1);
    // sleep_ms(4000);
  }
